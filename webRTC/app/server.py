...
logger = logging.getLogger("peer_connection")
...
async def offer(request):
    print("START OFFER, REQUEST: {request}")
    ...
    async def on_connectionstatechange():
        log_info("Connection state is %s", peer_connection.connectionState)
...
async def on_shutdown(app):
    ...
    coros = [peer_connection.close() for peer_connection in peer_connections]
